            ...
            <div className="data">
                ...
                <div className={"blackback"}>
                    <div className="content-tabs">
                        ...
                        >
                            Добро пожаловать в мой веб архив по эмо музыке. Идея создать такой сайт связана с тем, что
                            мне нравится
                            не просто слушать музыку, но так же и вникать в тексты и изучать историю групп. В этом месте
                            собраны эмо группы, которые
                            мне больше всего понравились и затронули сердце. Создавать странички для них немного
                            времязатратный процесс, поэтому все будет появляться постепенно.
                            Скажу сразу, я не занимаюсь фронтендом профессионально, поэтому возможно, кому-то интерфейс
                            покажется всратым, но это здесь не главное :)
                            <br/><br/>
                            <img src={'https://dannarchy.com/misc/anim/myskull.gif'}
                                 style={{display: 'block', margin: '0 auto'}} alt={''}/>
                            <div>Если есть какие-то пожелания (добавить какие-то группы) или у вас есть крутая инфа или
                                видосы,
                        ...
                        >
                            <div>
                                ...
                                К середине 1990-х многочисленные эмо-группы появились на Среднем Западе и в центральной
                                части США, а
                                также несколько инди-лейблов стали специализироваться в данном стиле. Эмо ворвался в
                                мейнстрим в начале 2000-х,
                                ...
                                <p>
                                    ...
                                    постхардкора.
                                    <br/>К пионерам жанра можно отнести такие группы, как Sunny Day Real Estate, The
                                    Promise Ring, Mineral[1] и другие эмо-группы 90-х.
                                </p>
                                <h3>История</h3>
                                <p>
                                    Вслед за успехом альбома Nevermind (1991) группы Nirvana, андеграундная рок-музыка в
                                    Соединённых Штатах превратилась в один большой бизнес. Появились новые
                                    дистрибьюторские сети, а различные инди-группы получили доступ к национальному
                                    уровню. Подростки по всей стране объявили себя поклонниками независимой музыки, быть
                                    панком и приверженцем sXe стало модной тенденцией. В этом новом музыкальном климате,
                                    эстетика эмо расширилась в сторону мейнстрима. Поскольку Sunny Day Real Estate
                                    фактически были основателями жанра, основное признание и популярность досталась
                                    им.[2]
                                </p>
                            </div>
                        </div>
